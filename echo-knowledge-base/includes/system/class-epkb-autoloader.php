	...
	public static function autoload( $class ) {
		...
		if ( $classes === null ) {
			$classes = array(
				...
				'epkb_ai_conversation_service'      =>  'includes/ai/services/class-epkb-ai-conversation-service.php',
				...
				'epkb_ai_chat_security'             =>  'includes/ai/support/class-epkb-ai-chat-security.php',
