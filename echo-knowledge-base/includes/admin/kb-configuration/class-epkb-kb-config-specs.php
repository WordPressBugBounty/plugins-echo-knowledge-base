...
class EPKB_KB_Config_Specs {
	...
	public static function get_fields_specification( $kb_id ) {
		...
		$config_specification = array(
			...
			'navigation_sidebar_sticky_toggle' => array(
				'label'       => esc_html__( 'Sticky Sidebar', 'echo-knowledge-base' ),
			...
			'template_main_page_display_title' => array(
				'label'       => esc_html__( 'Page Title', 'echo-knowledge-base' ),
			...
			'faq_answer_text_color' => array(
				'label'       => esc_html__( 'Answer Text', 'echo-knowledge-base' ),
	...
	public static function shared_configuration() {
		...
		$shared_specification = array(
			 ...
			 *
			 ******************************************************************************/
			'ai_vector_store_id'                              => array(
				'label'     => esc_html__( 'Vector Store ID', 'echo-knowledge-base' ),
				'name'      => 'ai_vector_store_id',
				'max'       => '100',
				'min'       => '0',
				'mandatory' => false,
				'type'      => EPKB_Input_Filter::TEXT,
			...
			'ai_disclaimer_accepted' => array(
				'label'     => esc_html__( 'AI Disclaimer Accepted', 'echo-knowledge-base' ),
			...
			'ai_search_enabled' => array(
				'label'       => esc_html__( 'AI Search Feature', 'echo-knowledge-base' ),
			...
			'ai_chat_enabled' => array(
				'label'       => esc_html__( 'AI Chat Feature', 'echo-knowledge-base' ),
