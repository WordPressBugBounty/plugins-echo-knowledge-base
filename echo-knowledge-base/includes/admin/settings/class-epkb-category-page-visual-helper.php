		...
		if ( $current_page_template === 'current_theme_templates' ) { ?>
			...
			if ( $category_search_toggle ) { ?>
				...
				<?php echo esc_html__( 'KB setting for Search Width', 'echo-knowledge-base' ) . ': ' . esc_attr( $category_search_width . $category_search_width_units ) .
                    ...
                    <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=epkb_post_type_' . $kb_id . '&page=epkb-kb-configuration#settings__archive-page__archive-page__search-options-archive' ) ); ?>"
			...
			<?php echo esc_html__( 'KB setting for Archive Width', 'echo-knowledge-base' ) . ': ' . esc_attr( $category_content_width . $category_content_width_units ) .
				...
				<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=epkb_post_type_' . $kb_id . '&page=epkb-kb-configuration#settings__archive-page__archive-page__content-archive' ) ); ?>"
				   target="_blank" class="epkb-vshelp-accordion-body-content__note"><span class="epkbfa epkbfa-external-link"></span></a>
			</div>
			...
			<ul>
				<li><?php echo esc_html__( 'Category Archive Page width is controlled by search box width, sidebar widths and other settings.', 'echo-knowledge-base' ) .
				...
				if ( $current_page_template == 'current_theme_templates' ) { ?>
					<li><?php echo esc_html__( 'You are currently using the Current theme template. Check your theme settings or switch to the KB template.', 'echo-knowledge-base' ) .
