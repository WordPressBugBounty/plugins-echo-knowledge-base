	...
	protected function get_this_block_inline_styles( $block_attributes ) {
		...
		$output .=
			...
			$block_selector . ' ' . '.epkb-ml-2-lvl__cat-content {
			    background-color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['ml_categories_articles_article_bg_color'] ) . ';
			}' .
			...
			$block_selector . ' ' . '.epkb-ml-5-lvl__cat-content .epkb-ml-articles-coming-soon {
			    color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['section_head_description_font_color'] ) . ';
			}' .
			$block_selector . ' ' . '.epkb-back-button {
			    background-color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['ml_categories_articles_back_button_bg_color'] ) . '!important;
			}' .
			$block_selector . ' ' . '.epkb-back-button:hover {
			    background-color: ' . EPKB_Utilities::darken_hex_color( EPKB_Utilities::sanitize_hex_color( $block_attributes['ml_categories_articles_back_button_bg_color'] ), 0.2 )  . '!important;
			}' .
			...
			$block_selector . ' ' . '.epkb-ml-top-categories-button-container .epkb-ml-top__cat-container--active:hover {
			    box-shadow: 0 0 0 4px ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['section_border_color'] ) . ';
			}' .
			...
			$block_selector . ' ' . '.epkb-ml-5-lvl-categories-button-container .epkb-ml-5-lvl__cat-container:hover {
			    border-color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['section_border_color'] ) . ';
			}' .
			...
			$block_selector . ' ' . '.epkb-ml-5-lvl-categories-button-container .epkb-ml__cat-container--active:hover{
			    box-shadow: 0px 1px 0 0px ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['section_category_icon_color'] ) . ';
			    border-color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['section_category_icon_color'] ) . ';
			}' .
