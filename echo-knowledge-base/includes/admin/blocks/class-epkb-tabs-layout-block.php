	...
	protected function get_this_block_inline_styles( $block_attributes ) {
		...
		$output .=
			...
			$block_selector . ' ' . '.epkb-main-nav .epkb-cat-name,.main-category-selection-1 .epkb-category-level-1 {
				...
				font-weight: ' . intval( EPKB_Blocks_Settings::get_font_appearance_weight( $block_attributes['tab_nav_name_typography_controls'], $block_ui_specs['tab_nav_name_typography_controls'] ) ) . ' !important;
				font-style: ' . esc_attr( EPKB_Blocks_Settings::get_font_appearance_style( $block_attributes['tab_nav_name_typography_controls'], $block_ui_specs['tab_nav_name_typography_controls'] ) ) . ' !important;
			...
			$block_selector . ' ' . '.epkb-main-nav .epkb-cat-desc {
				...
				font-weight: ' . intval( EPKB_Blocks_Settings::get_font_appearance_weight( $block_attributes['tab_nav_desc_typography_controls'], $block_ui_specs['tab_nav_desc_typography_controls'] ) ) . ' !important;
				font-style: ' . esc_attr( EPKB_Blocks_Settings::get_font_appearance_style( $block_attributes['tab_nav_desc_typography_controls'], $block_ui_specs['tab_nav_desc_typography_controls'] ) ) . ' !important;
		...
		$output .=
			$block_selector . ' ' . '#epkb-content-container .epkb-nav-tabs .active:after {
				border-top-color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['tab_nav_active_background_color'] ) . '!important
			}' .
			$block_selector . ' ' . '#epkb-content-container .epkb-nav-tabs .active {
				background-color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['tab_nav_active_background_color'] ) . '!important
			}' .
			...
			$block_selector . ' ' . ' #epkb-content-container .epkb-nav-tabs .active p {
				color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['tab_nav_active_font_color'] ) . '!important
			}' .
			$block_selector . ' ' . '#epkb-content-container .epkb-nav-tabs .active:before {
				border-top-color: ' . EPKB_Utilities::sanitize_hex_color( $block_attributes['tab_nav_border_color'] ) . '!important
			}
		';
