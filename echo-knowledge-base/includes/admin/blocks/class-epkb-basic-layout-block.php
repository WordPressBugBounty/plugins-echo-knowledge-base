...
final class EPKB_Basic_Layout_Block extends EPKB_Abstract_Block {
	const EPKB_BLOCK_NAME = 'basic-layout';

	protected $block_name = 'basic-layout';
	...
	protected function get_this_block_inline_styles( $block_attributes ) {
		...
		$block_selector = '.eckb-kb-block-basic-layout #epkb-ml__module-categories-articles #epkb-ml-basic-layout';
		$sidebar_selector = '.eckb-kb-block-basic-layout #epkb-ml-cat-article-sidebar';
					...
					'articles-list' => array(
						...
						'fields' => array(
							...
							'expand_articles_icon' => array(
								'setting_type' => 'dropdown',
								'options'     => array(
									'ep_font_icon_plus_box' => _x( 'Plus Box', 'icon type', 'echo-knowledge-base' ),
